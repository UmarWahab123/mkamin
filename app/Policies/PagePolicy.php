...
class PagePolicy
{
     ...
     */
    public function view(User $user, Page $pageResource): bool
    {
     ...
     */
    public function update(User $user, Page $pageResource): bool
    {
     ...
     */
    public function delete(User $user, Page $pageResource): bool
    {
     ...
     */
    public function forceDelete(User $user, Page $pageResource): bool
    {
     ...
     */
    public function restore(User $user, Page $pageResource): bool
    {
     ...
     */
    public function replicate(User $user, Page $pageResource): bool
    {
