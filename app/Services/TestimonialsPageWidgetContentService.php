...
class TestimonialsPageWidgetContentService
{
    /**
     * Get all testimonials page widget content data
     *
     * @param int $cacheTime Cache time in minutes
     * @return array
     */
    public function getTestimonialsPageContent($cacheTime = 60)
    {
        // Cache the data for specified minutes (default: 60 minutes)
        return Cache::remember('testimonials_page_data', $cacheTime * 60, function () {
